...
export const emailTemplate=(email)=>{
    const emailToken=jwt.sign({email: email}, "EmailKey")
    return (`
        <!--
...
<style type="text/css">
@media (max-width: 480px) {
.t23,.t28{mso-line-height-alt:0px!important;line-height:0!important;display:none!important}.t24{padding:40px!important;border-radius:0!important}.t20,.t22{max-width:398px!important}
}
</style>
<!--[if !mso]>-->
  ...
  <tr>
    <td class="t21" style="width:auto;">
      ...
      style="width:auto;max-width:514px;">
        <tr>
          <td class="t19" 
          style="overflow:hidden;background-color:#0666EB;text-align:center;line-height:34px;
          mso-line-height-rule:exactly;mso-text-raise:5px;padding:0 23px;border-radius:40px;">
            
          <a href="http://localhost:3000/user/verify/${emailToken}" 


               style="display:block;margin:0;font-family:Sofia Sans,BlinkMacSystemFont,Segoe UI,Helvetica Neue,Arial,sans-serif;
               line-height:34px;font-weight:700;font-size:16px;text-decoration:none;text-transform:none;letter-spacing:-0.2px;
               direction:ltr;color:#FFFFFF;text-align:center;">
              Confirm
            </a>
          </td>
        </tr>
